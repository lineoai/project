...
const HeroSection = () => {
  return (
    <MaxWrapper className="w-full p-4">
      <div className="w-full relative min-h-[94vh] rounded-xl 2xl:rounded-3xl hero-bg flex items-center justify-center overflow-hidden xl:max-w-screen-2xl mx-auto">
